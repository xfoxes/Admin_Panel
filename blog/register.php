					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								...
								<input  type="text" name="user-name" placeholder="Kullanıcı Adı"><br>
								<input  type="password" name="password" placeholder="Şifre"><br>
								<input  type="password" name="password" placeholder="Tekrar Şifre"><br>
								<button class="button big fit">Üye ol</button>
