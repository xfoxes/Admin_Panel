    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 style="color:#327ab7; font-weight:bold;" class="page-header">Article Add</h1>
                        
                    </div>
                    <form action="" method="POST" enctype="multipart/form-data">
                    <input type="text" class="form-control" name="title" placeholder="Title"><br>
                    <b>Yazı Resmi Seçiniz :</b><input type="file" name="dosya"><br>
                    <textarea name="editor" id="editor" class="ckeditor"></textarea><br>
                    ...
                    <br>
                    <br>
                    <input type="text" class="form-control" name="tags" placeholder="#Etiket"><br>
                    <button class="btn btn-default" type="submit" name="yazi_ekle" type="button">Ekle</button>
                    </form>
                    <?php
                    if(isset($_POST["yazi_ekle"])){
